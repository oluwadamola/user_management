...
namespace UserManagement.App_Start
{
    ...
    using UserManagement.Models.Managers;
    ...
    public static class NinjectWebCommon 
    {
        ...
        {
            kernel.Bind<DbContext>().To<DataEntities>().InRequestScope();
            //kernel.Bind<DbContext>().To<DbContext>().InRequestScope();
            kernel.Bind<IDataRepository>().To<EntityRepository>().InRequestScope();
